  ...
  graphObject: function() {
  	let {options, data} = this.props
		...
		if(options.timeseries){
			let format = data[0].values[0].label.substring(0,4) == data[0].values[1].label.substring(0,4) ? '%m/%Y' : '%Y'
...
//c3.js
	drawGraph: function() {
		switch(this.props.type){
			case "line":
				this.drawGraphLineOrArea(false);
			break;
			case "area":
				this.drawGraphLineOrArea(true);
			break;
			case "bar":
				this.drawGraphBar();
			break;
			...
			break;
			case "multiBar":
				this.drawGraphMultiBar(false);
			break;
			case "multiBarGroup":
				this.drawGraphMultiBar(true)
			break;
			case "lineBar":
	...
	drawGraphLineOrArea: function(area) {
