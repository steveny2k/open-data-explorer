        ...
        return (
             <g transform={transform}>
                ...
                <text is visibility={visibility} transform={transformText}>
                    <tspan is x="0" text-anchor="middle" font-size="15px" fill="#696969">{this.props.tooltip.data.key}</tspan>
                    <tspan is x="0" text-anchor="middle" dy="25" font-size="20px" fill="#696969"> {this.props.tooltip.data.value}</tspan>
                </text>
            </g>
        )
    }
